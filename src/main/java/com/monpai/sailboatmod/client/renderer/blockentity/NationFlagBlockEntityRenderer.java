...
public class NationFlagBlockEntityRenderer implements BlockEntityRenderer<NationFlagBlockEntity> {
    ...
    private void renderStandingFlag(NationFlagBlockEntity blockEntity, float partialTick, PoseStack poseStack,
    ...
    private static void drawWavingFlagSurface(PoseStack poseStack, VertexConsumer consumer, int packedLight, int packedOverlay,
                                               FlagGeometry geometry, NationFlagBlockEntity blockEntity, float partialTick) {
        ...
        for (int i = 0; i < WAVE_SEGMENTS; i++) {
            ...
            // Progressive wave: bottom segments sway more than top
