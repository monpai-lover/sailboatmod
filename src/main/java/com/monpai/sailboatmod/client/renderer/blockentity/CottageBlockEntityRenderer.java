...
public class CottageBlockEntityRenderer implements BlockEntityRenderer<CottageBlockEntity> {
    private final Font font;
    public CottageBlockEntityRenderer(BlockEntityRendererProvider.Context ctx) { this.font = ctx.getFont(); }

    @Override
    public void render(CottageBlockEntity be, float pt, PoseStack ps, MultiBufferSource buf, int light, int overlay) {
    ...
    @Override public boolean shouldRenderOffScreen(CottageBlockEntity be) { return true; }
